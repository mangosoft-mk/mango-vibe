    ...
    return (
        <div className={cn(
            ...
            <div className="flex item-center gap-2 pl-2 mb-2">
                <Image src='/logo.svg' alt='MangoVibe' height={18} width={18} className="shrink-0" />
...
const FragmentCard = ({ fragment, isActiveFragment, onFragmentClick }: FragmentProps) => {
    return (
        <button className={cn(
            "flex items-start text-start gap-2 border rounded-lg bg-muted w-fit p-3 hover:bg-primary hover:text-primary-foreground transition-colors",
